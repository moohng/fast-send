  ...
  return (
    <div className="p-4 flex items-end gap-3 mx-auto w-full">
      <button
        ...
        className={`w-12 h-12 flex items-center justify-center rounded-full transition-all shrink-0 plus-button ${isMenuOpen ? 'bg-slate-800 text-white rotate-45' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'}`}
      >
        <Plus size={22} />
      </button>
